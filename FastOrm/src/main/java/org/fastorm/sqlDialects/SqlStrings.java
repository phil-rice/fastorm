...
public class SqlStrings implements ISqlStrings {
	...
	public String getFromTemplate(String templateName, IJobOptimisations optimisations, Map<String, ? extends Object> map, Object... other) {
		...
		if (!optimisations.useTemporaryTables())
